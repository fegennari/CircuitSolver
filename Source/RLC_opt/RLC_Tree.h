...
#define TYPE_IS_INV(i)   (params[i].type == TYPE_INV)
...
private:
	...
	void prop_branch_dep(unsigned nn, unsigned nn_parent, int last_tline, int last_mos, int last_inv);
