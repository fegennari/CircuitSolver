...
public:
	...
	int get_gradient(vector<double> &gradient, vector<double> &gradient2, double &val, double &val2);
	int meets_constaints(double &over_val);
	...
	int is_sizing_monotonic(vector<double> &x) const {return op->is_sizing_monotonic(x);};
